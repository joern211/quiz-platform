...
export const GAME_MANIFESTS: GameManifest[] = [
  ...
  { slug: 'geo', name: 'Geografie-Quiz', category: 'quiz-wissen', shortDescription: 'Multiple-Choice Quiz mit Joker', description: 'Teste dein Geografie-Wissen mit vier Antwortoptionen und nutze Joker.', minPlayers: 2, maxPlayers: 10, estimatedDurationMinutes: 15, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['quiz', 'joker', 'timer'], status: 'AVAILABLE', hasBuzzer: false, hasTeams: false, hasCamera: false, hasAudio: true, hasTimer: true },
  { slug: 'allgemeinwissen', name: 'Allgemeinwissen-Quiz', category: 'quiz-wissen', shortDescription: 'Fragen aus allen Wissensgebieten', description: 'Allgemeinwissen aus verschiedenen Bereichen.', minPlayers: 2, maxPlayers: 10, estimatedDurationMinutes: 15, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['quiz'], status: 'PLANNED', hasBuzzer: false, hasTeams: false, hasAudio: false, hasTimer: true },
  { slug: 'wer-wird-millionaer', name: 'Wer wird Millionär', category: 'quiz-wissen', shortDescription: 'Aufsteigende Schwierigkeit mit Jokern', description: 'Die klassische Quizshow mit Gewinnleiter und Jokern.', minPlayers: 1, maxPlayers: 4, estimatedDurationMinutes: 30, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['quiz', 'show'], status: 'PLANNED', hasBuzzer: false, hasTeams: false, hasCamera: false, hasAudio: false, hasTimer: true },
  
  // Kategorie 2: Buzzer & Reaktion
  { slug: 'jeopardy', name: 'Jeopardy', category: 'buzzer-reaktion', shortDescription: '2 Boards, 6 Kategorien, Abstauber', description: 'Wähle Felder, beantworte Fragen und staube bei falschen Antworten ab.', minPlayers: 2, maxPlayers: 10, estimatedDurationMinutes: 30, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['buzzer', 'board'], status: 'AVAILABLE', hasBuzzer: true, hasTeams: false, hasCamera: false, hasAudio: false, hasTimer: true },
  { slug: 'song-erraten', name: 'Erkenne den Song', category: 'buzzer-reaktion', shortDescription: 'Musik-Buzzer-Spiel', description: 'Höre Clips und sei der Erste, der Titel und Interpret nennt.', minPlayers: 2, maxPlayers: 10, estimatedDurationMinutes: 20, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['buzzer', 'audio'], status: 'AVAILABLE', hasBuzzer: true, hasTeams: false, hasCamera: false, hasAudio: true, hasTimer: false },
  { slug: 'wer-ist-das', name: 'Wer ist das?', category: 'buzzer-reaktion', shortDescription: 'Fusionbilder erkennen', description: 'Errate welche beiden Personen im Fusionsbild stecken.', minPlayers: 2, maxPlayers: 10, estimatedDurationMinutes: 15, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['buzzer', 'fusion'], status: 'AVAILABLE', hasBuzzer: true, hasTeams: false, hasCamera: false, hasAudio: false, hasTimer: false },
  
  // Kategorie 3: Schätzen & Sortieren
  { slug: 'timeline', name: 'Timeline', category: 'schaetzen-sortieren', shortDescription: 'Elemente chronologisch einordnen', description: 'Ordne Bilder oder Werte in die richtige Reihenfolge ein.', minPlayers: 2, maxPlayers: 10, estimatedDurationMinutes: 20, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['sortieren', 'leben'], status: 'AVANNING', hasBuzzer: false, hasTeams: false, hasCamera: false, hasAudio: false, hasTimer: false },
  { slug: 'schaetz-mal', name: 'Schätz mal', category: 'schaetzen-sortieren', shortDescription: 'Zahlenwerte schätzen', description: 'Schätze Zahlenwerte - die geringste Abweichung gewinnt.', minPlayers: 2, maxPlayers: 10, estimatedDurationMinutes: 15, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['schaetzen'], status: 'PLANNED', hasBuzzer: false, hasTeams: false, hasCamera: false, hasAudio: false, hasTimer: true },
  { slug: 'higher-lower', name: 'Higher or Lower', category: 'schaetzen-sortieren', shortDescription: 'Höher oder niedriger entscheiden', description: 'Entscheide ob der nächste Wert höher oder niedriger ist.', minPlayers: 2, maxPlayers: 10, estimatedDurationMinutes: 10, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['schaetzen'], status: 'PLANNED', hasBuzzer: false, hasTeams: false, hasCamera: false, hasAudio: false, hasTimer: false },
  
  // Kategorie 5: Bluff & Täuschung
  { slug: 'wer-luegt', name: 'Wer lügt am besten?', category: 'bluff-taeuschung', shortDescription: 'Echte und erfundene Antworten voten', description: 'Schreibe plausible falsche Antworten und vote für die beste Lüge.', minPlayers: 3, maxPlayers: 10, estimatedDurationMinutes: 20, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['bluff', 'vote'], status: 'AVAILABLE', hasBuzzer: false, hasTeams: false, hasCamera: false, hasAudio: false, hasTimer: false },
  { slug: 'wahrheit-oder-fake', name: 'Wahrheit oder Fake?', category: 'bluff-taeuschung', shortDescription: 'Echte von falschen Behauptungen unterscheiden', description: 'Stimme ab ob Behauptungen wahr oder erfunden sind.', minPlayers: 2, maxPlayers: 10, estimatedDurationMinutes: 15, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['bluff', 'vote'], status: 'PLANNED', hasBuzzer: false, hasTeams: false, hasCamera: false, hasAudio: false, hasTimer: false },
];

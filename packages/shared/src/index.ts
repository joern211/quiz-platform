...
export const GAME_MANIFESTS: GameManifest[] = [
  ...
  // Kategorie 2: Buzzer & Reaktion — BETA (engines not yet connected)
  { slug: 'jeopardy', name: 'Jeopardy', category: 'buzzer-reaktion', setupSchemaVersion: 1, shortDescription: '2 Boards, 6 Kategorien, Abstauber', description: 'Wähle Felder, beantworte Fragen und staube bei falschen Antworten ab.', minPlayers: 2, maxPlayers: 10, estimatedDurationMinutes: 30, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['buzzer', 'board'], status: 'BETA', hasBuzzer: true, hasTeams: false, hasCamera: false, hasAudio: false, hasTimer: true },
  { slug: 'song-erraten', name: 'Erkenne den Song', category: 'buzzer-reaktion', setupSchemaVersion: 1, shortDescription: 'Musik-Buzzer-Spiel', description: 'Höre Clips und sei der Erste, der Titel und Interpret nennt.', minPlayers: 2, maxPlayers: 10, estimatedDurationMinutes: 20, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['buzzer', 'audio'], status: 'BETA', hasBuzzer: true, hasTeams: false, hasCamera: false, hasAudio: true, hasTimer: false },
  { slug: 'wer-ist-das', name: 'Wer ist das?', category: 'buzzer-reaktion', setupSchemaVersion: 1, shortDescription: 'Fusionbilder erkennen', description: 'Errate welche beiden Personen im Fusionsbild stecken.', minPlayers: 2, maxPlayers: 10, estimatedDurationMinutes: 15, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['buzzer', 'fusion'], status: 'BETA', hasBuzzer: true, hasTeams: false, hasCamera: false, hasAudio: false, hasTimer: false },
  ...
  // Kategorie 5: Bluff & Täuschung — BETA (engines not yet connected)
  { slug: 'wer-luegt', name: 'Wer lügt am besten?', category: 'bluff-taeuschung', setupSchemaVersion: 1, shortDescription: 'Echte und erfundene Antworten voten', description: 'Schreibe plausible falsche Antworten und vote für die beste Lüge.', minPlayers: 3, maxPlayers: 10, estimatedDurationMinutes: 20, roles: ['MODERATOR', 'PLAYER', 'VIEWER'], tags: ['bluff', 'vote'], status: 'BETA', hasBuzzer: false, hasTeams: false, hasCamera: false, hasAudio: false, hasTimer: false },
